				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="common.fournisseur"></spring:message>
						</h1>
					</div>
				</div>
				<div class="row">
					<div class="lol-lg-12">
						<ol class="breadcrumb">
							<li><a href='<c:url value="/fournisseur/nouveau"></c:url>'> <i
					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<spring:message code="fournisseur.liste"></spring:message>
							</div>
							<!-- /.panel-heading -->
										...
										<c:forEach items="${fournisseurs }" var="fournisseur">
											<tr class="odd gradeX">
												...
												<c:url value="/fournisseur/modifier/${fournisseur.getIdFournisseur() }" var="urlModifier">
														...
														<a href="javascript:void(0);"	data-toggle="modal" data-target="#modalClient${fournisseur.getIdFournisseur() }">
															<i class="fa  fa-trash-o"></i>
														</a> 
														<!-- Modal -->
													<div class="modal fade" id="modalClient${fournisseur.getIdFournisseur() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
														aria-hidden="true">
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<spring:message code="fournisseur.confirm.suppression.msg"></spring:message>
																</div>
