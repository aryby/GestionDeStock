										...
										<c:forEach items="${articles }" var="article">
											<tr class="odd gradeX">
												...
												<c:url value="/article/modifier/${article.getIdArticle() }" var="urlModifier">
														...
														<a href="javascript:void(0);"	data-toggle="modal" data-target="#modalClient${article.getIdArticle() }">
															<i class="fa  fa-trash-o"></i>
														</a> 
														<!-- Modal -->
													<div class="modal fade" id="modalClient${article.getIdArticle() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
														aria-hidden="true">
