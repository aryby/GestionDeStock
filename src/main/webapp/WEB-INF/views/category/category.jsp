				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="common.category"></spring:message>
						</h1>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<spring:message code="category.liste"></spring:message>
							</div>
							<!-- /.panel-heading -->
														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<spring:message code="category.confirm.suppression.msg"></spring:message>
																</div>
